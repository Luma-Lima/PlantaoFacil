...
public interface Horario_EscalaDAO extends JpaRepository<Horario_Escala, java.lang.String> {
  ...
  public Horario_Escala findOne(@Param(value="id") java.lang.String id);
